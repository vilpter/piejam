...
TYPED_TEST(pcm_convert_test, from_middle)
{
    ...
    EXPECT_FLOAT_EQ(
        desc_t::fmiddle,
        from<desc_t::format>(endian_to_format<desc_t::format>(desc_t::middle)));
}
...
TYPED_TEST(pcm_convert_test, from_min)
{
    ...
    EXPECT_FLOAT_EQ(
        desc_t::fmin,
        from<desc_t::format>(endian_to_format<desc_t::format>(desc_t::min)));
}
...
TYPED_TEST(pcm_convert_test, from_max)
{
    ...
    EXPECT_FLOAT_EQ(
        desc_t::fmax,
        from<desc_t::format>(endian_to_format<desc_t::format>(desc_t::max)));
}
