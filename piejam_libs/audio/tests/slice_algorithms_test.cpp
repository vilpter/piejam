...
TEST(slice_algorithms_multiply, multiply_buffer_by_non_zero_one_constant)
{
    ...
    auto res =
        multiply(slice<float>(buf), slice<float>(3.f), std::span<float>(out));
...
TEST(slice_algorithms_multiply, multiply_buffer_by_minus_one_inverts_sign)
{
    ...
    auto res =
        multiply(slice<float>(buf), slice<float>(-1.f), std::span<float>(out));
...
TEST(slice_algorithms_multiply, multiply_non_zero_one_constant_by_buffer)
{
    ...
    auto res =
        multiply(slice<float>(4.f), slice<float>(buf), std::span<float>(out));
...
TEST(slice_algorithms_multiply, mulitply_two_buffers)
{
    ...
    auto res =
        multiply(slice<float>(buf1), slice<float>(buf2), std::span<float>(out));
